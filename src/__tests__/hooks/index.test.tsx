...
describe(`useCountries`, () => {
  ...
  it(`should return list of all countries if no filter passed`, async () => {
    ...
    expect(result.current.data).toEqual({ countries: COUNTRIES });
  });

  it(`should return list of countries whose country code matching filter value`, async () => {
    const countryCodeFilter = "AZ";
